...
public class SyslogHandler extends Handler {
	static void readConfig() throws SecurityException, IOException {
		if (System.getProperty(
				PropertyNames.JAVA_UTIL_LOGGING_CONFIG_FILE) == null) {
			LogManager.getLogManager().readConfiguration(SyslogHandler.class
	...
	public SyslogHandler() throws SocketException, UnknownHostException {
		...
		String syslogHost = LogManager.getLogManager()
				.getProperty(getClass().getName() + ".host");
		String syslogPort = LogManager.getLogManager()
				.getProperty(getClass().getName() + ".port");
	...
	public void publish(LogRecord r) {
		...
		dateFormatter.format("%1$tb %2$2d %1$TT", cal,
